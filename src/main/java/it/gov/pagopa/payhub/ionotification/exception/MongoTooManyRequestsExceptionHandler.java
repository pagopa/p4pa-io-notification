...
public class MongoTooManyRequestsExceptionHandler {
    ...
    protected ResponseEntity<IoNotificationErrorDTO> handleDataAccessException(
        ...
        if (isRequestRateTooLargeException(ex)) {
            ...
            return IONotificationExceptionHandler.handleException(ex, request, HttpStatus.INTERNAL_SERVER_ERROR, IoNotificationErrorDTO.CodeEnum.IO_NOTIFICATION_GENERIC_ERROR);
        }
    }
